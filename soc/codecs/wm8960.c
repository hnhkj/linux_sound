...
static int wm8960_init(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, WM8960_LOUT2, LOUT1_LO1VU|LOUT1_LO1ZC|LOUT1_LOUT1VOL(120));//0x28
	snd_soc_write(codec, WM8960_ROUT2, ROUT1_RO1VU|ROUT1_RO1ZC|ROUT1_ROUT1VOL(120));//0x29
